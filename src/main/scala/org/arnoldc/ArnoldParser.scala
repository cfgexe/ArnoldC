...
class ArnoldParser extends Parser {
  ...
  val ParseError = "u got this wrong pal"

  val DeclareInt = "HEY CHRISTMAS TREE"
  val SetInitialValue = "decinit"
  val BeginMain = "create main"
  val PlusOperator = "+"
  val MinusOperator = "-"
  ...
  val Print = "say"
  val Read = "input"
  val AssignVariable = "dec"
  val SetValue = "="
  val EndAssignVariable = "enddec"
  val False = "false"
  val True = "true"
  val EqualTo = "=="
  val GreaterThan = ">="
  ...
  val EndIf = "endif"
  val While = "while"
  val EndWhile = "endwhile"
  val DeclareMethod = "create"
  val MethodArguments = "argument"
  val Return = "return"
  val EndMethodDeclaration = "end"
  val CallMethod = "call"
